...
$sql1="SELECT `student_id`, `subject`, `total`, `obtain`, `grade`, `exam_name`, `session` FROM `result_brief` WHERE `student_id`= '$student_id' AND `exam_name` = '$exam_name' AND `session`= '$session'";
