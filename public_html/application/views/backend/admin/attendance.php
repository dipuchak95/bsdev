	    ...
	    <div class="row">
		    ...
		    <div class="col-sm-3">
    		    <div class="form-group label-floating" style="background:#fff;">
                    ...
                    <input type='text' data-date-format='yyyy-mm-dd' class="datepicker-here" data-position="bottom left" data-language='en' value="<?php echo date('Y-m-d');?>" name="timestamp" data-multiple-dates-separator="-"/>
