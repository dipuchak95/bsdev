                    ...
                    <table class="table table-padded">
                      ...
                      <tbody>
			           ...
			           <tr>
                        ...
                        <td><?php echo date('d-m-Y', strtotime($row['issue_start_date']));?></td>
                        <td><?php echo date('d-m-Y', strtotime($row['issue_end_date']));?></td>
                        <td>
                            <?php
                                if($row['status'] == 0)
                        ...
                        <td>
                            <?php if($row['status'] == 0) { ?>
                                <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('approve');?>" onClick="return confirm('<?php echo get_phrase('confirm_approval');?>')" href="<?php echo base_url();?>admin/book_request/accept/<?php echo $row['book_request_id'];?>"><i style="color:gray" class="picons-thin-icon-thin-0154_ok_successful_check"></i></a>
						        <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('reject');?>" onClick="return confirm('<?php echo get_phrase('confirm_reject');?>')" href="<?php echo base_url();?>admin/book_request/reject/<?php echo $row['book_request_id'];?>"><i style="color:gray" class="picons-thin-icon-thin-0153_delete_exit_remove_close"></i></a>
