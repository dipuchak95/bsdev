		...
		<div class="os-tabs-w menu-shad">
			<div class="os-tabs-controls">
				<ul class="navs navs-tabs upper">
					...
					<li class="navs-item">
						<a class="navs-links active" href="<?php echo base_url();?>admin/fees_discount/"><i
								class="os-icon picons-thin-icon-thin-0086_import_file_load"></i>
				...
				<div class="row">
					...
					<div class="col-sm-2">
						<div class="form-group">
							<button class="btn btn-success btn-upper" id="add_discount" style="margin-top:10px" onclick="addDiscount()"
