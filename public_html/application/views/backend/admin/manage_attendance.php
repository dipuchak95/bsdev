...
<div class="content-w">
 ...
 <div class="content-i">
      ...
      <div class="row">
		...
		<div class="col-sm-3">
		    <div class="form-group label-floating" style="background:#fff;">
                ...
                <input type='text' class="datepicker-here" data-position="bottom left" data-language='en' name="timestamp" data-multiple-dates-separator="-" value="<?php echo $timestamp; ?>"/>
    ...
    <?php if($section_id > 0 && $class_id > 0):?>
    <div class="ui-block">
                <article class="hentry post thumb-full-width">                
                  <div class="post__author author vcard inline-items">
                    ...
                    <div class="author-date">
                      <a class="h6 post__author-name fn" href="javascript:void(0);"><?php echo get_phrase('attendance');?> <small>(<?php echo $timestamp; ?>)</small>.</a>
                    </div>                
                  </div>                
