 		...
 		<div class="os-tabs-w menu-shad">
 			<div class="os-tabs-controls">
 				<ul class="navs navs-tabs">
 					...
 					<li class="navs-item">
 						<a class="navs-links <?php if($page_name == 'tabulation_report') echo "active";?>"
 						...
 						<div class="form-group label-floating is-select">
 							...
 							<div class="select">
 								<select name="class_id" required=""
 									onchange="get_class_sections(this.value); get_class_subjects(this.value)">
 					...
 					<div class="col-sm-2">
 						<div class="form-group">
 							<button class="btn btn-success btn-upper" style="margin-top:20px"
 								type="submit"><span><?php echo get_phrase('get_report');?></span></button>
 						</div>
 					</div>
 				</div>
 				<?php echo form_close();?>
 						...
 						<table cellpading="0" cellspacing="0" border="1" style="margin: 20px 0;" class="bg-white">
 							...
 							<tr class="text-center" id="student-<?php echo $row['student_id'];?>">
 								...
 								<td class="text-center">
 									<?php if($this->db->get_where('student', array('student_id' => $row['student_id']))->row()->sex == 'M') echo "M"; else echo "F";?>
 								</td>
 								<td class="text-center">
 									<?php echo $this->crud_model->get_name('student', $row['student_id']);?></td>
 								<?php 	
										$average = 0;
                    				...
                    				?>
 								<td class="text-center">
 									<?php echo $this->db->get_where('mark', array('student_id' => $row['student_id'], 'year' => $running_year, 'exam_id' => $key['exam_id'],'subject_id' => $subject_id))->row()->labtotal;?>
 								</td>
 								<?php endforeach;?>
