    ...
    <div class="os-tabs-w menu-shad">
      <div class="os-tabs-controls">
        <ul class="navs navs-tabs upper">
          ...
          <li class="navs-item">
            <a class="navs-links active" href="<?php echo base_url();?>admin/upload_marks/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?php echo get_phrase('marks');?></span></a>
          </li>
        </ul>
      </div>
    </div>
                  ...
                  $marks_of_students = $this->db->get_where('mark' , array('class_id' => $ex[0], 'section_id' => $ex[1] ,'year' => $running_year,'subject_id' => $ex[2],'exam_id' => $exam_id))->result_array();
                    ...
                    <tr style="height:25px;">                    
                      ...
                      <td class="text-center">
                          <center><input type="text" name="marks_obtained_<?php echo $row['mark_id'];?>" placeholder="0" style="text-align: center;" value="<?php echo $row['mark_obtained'];?>"></center>
                      </td>
                      <td>
                           <center><input type="text" name="lab_uno_<?php echo $row['mark_id'];?>" placeholder="0" style=" text-align: center;" value="<?php echo $row['labuno'];?>"></center>
                      </td>
                      <td>
                        <center><input type="text" name="lab_dos_<?php echo $row['mark_id'];?>" placeholder="0" style=" text-align: center;" value="<?php echo $row['labdos'];?>"></center>
                      </td>
                      <!--<td>  
                      ...
                      <td>
                        <input type="text" name="lab_siete_<?php echo $row['mark_id'];?>" placeholder="0" style="width:55px; border: 1; text-align: center;" value="<?php echo $row['labsiete'];?>"> 
                      </td>
                      <!--<td>
