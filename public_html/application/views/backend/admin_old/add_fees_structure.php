	  ...
	  <div class="os-tabs-w menu-shad">
		<div class="os-tabs-controls">
		  <ul class="navs navs-tabs upper">			
			<li class="navs-item">			  
				<a class="navs-links " href="<?php echo base_url();?>admin/fees/"><i class="os-icon picons-thin-icon-thin-0086_import_file_load"></i>
				<span><?php echo get_phrase('Fee Structure');?></span></a>
			</li>
			<li class="navs-item">        
			  <a class="navs-links active" href="<?php echo base_url();?>admin/add_fees_structure/"><i class="os-icon picons-thin-icon-thin-0086_import_file_load"></i>
	    ...
	    <div class="row">
    		    ...
    		    <div class="form-group label-floating is-select">
                    ...
                    <div class="select">
                        <select id="month_id">
                            <!--<option value=""><?php echo get_phrase('select');?></option>-->
							<?php
    					        $monthes = $this->db->get('month')->result_array();
			...
			<div class="col col-lg-2 col-md-3 col-sm-12 col-12">								
    				<div class="form-group date-time-picker ui-block label-floating">
                        ...
                        <input type='text' id="last_submsn_date" class="datepicker-here" data-position="bottom left" data-language='en' name="datetimepicker1" id="datetimepicker1" data-multiple-dates-separator="/"/>
				    </div>
				</div>	
			<div class="col-sm-2">
				<button class="btn btn-success" id="add_fees_structure_btn" style="margin-top:10px" type="submit"><?php echo get_phrase('add');?></button>
			</div>			
	    </div>
		<!--end row-->
        </div>
