                    ...
                    <table class="table table-padded">
                      <thead>
                        <tr>
							...
							<th><?php echo get_phrase('barcode');?></th>
           ...
           <?php echo form_open(base_url() . 'admin/library/create' , array('enctype' => 'multipart/form-data'));?>
              <div class="row">
                  ...
                  <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
					...
					<div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="form-group label-floating is-empty">
                            <label class="control-label"><?php echo get_phrase('barcode');?></label>
                          <input class="form-control" placeholder="" type="text" name="barcode" required="">
                        <span class="material-input"></span>
                      </div>
                    </div>
